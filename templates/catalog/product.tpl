              ...
              {block name='product_buy'}
                <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                  ...
                  {block name='product_variants'}
                    ...
                    {*Custom Feature-Footprint for CO2*}
                    {foreach from=$product.grouped_features item=feature}
                      
                      

                      {if $feature.name eq "CO2-Footprint"}

                        <span class="name control-label">Fußabdruck: </span>
                        {if $feature.value eq 1  }

                      
                        <span><i class="material-icons footprint-red">public</i></span>
                      
                        {elseif $feature.value eq 2 }
                        <span><i class="material-icons footprint-yellow">public</i></span>

                        {elseif $feature.value eq 3 }
                        <span><i class="material-icons footprint-green">public</i></span>
