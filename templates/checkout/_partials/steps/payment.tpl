  ...
  <div id="payment-confirmation">
    <div class="ps-shown-by-js">
      <button type="submit" {if !$selected_payment_option} disabled {/if} class="btn btn-primary center-block">
        {* {l s='Place order for a fee' d='Shop.Theme.Checkout'} *}
        {if $language.iso_code=='en'} {l s='complete order!' d='Shop.Theme.Checkout'}
        {elseif $language.iso_code=='de'}  {l s='kostenpflichtig bestellen!' d='Shop.Theme.Checkout'}
        {/if}
      </button>
      {if $show_final_summary}
